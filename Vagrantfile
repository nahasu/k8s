...
#-----Manager Node
    config.vm.define "k8s-m" do |subconfig|
      ...
      subconfig.vm.provision "shell", path: "https://raw.githubusercontent.com/nahasu/k8s/main/init_cfg.sh", args: [ N, k8s_V ]
      subconfig.vm.provision "shell", path: "http://github.com/nahasu/k8s/blob/main/master.sh", args: [ cni_N ]
    end
...
#-----Worker Node Subnet1
  (1..N).each do |i|
    config.vm.define "k8s-w#{i}" do |subconfig|
      ...
      subconfig.vm.provision "shell", path: "https://raw.githubusercontent.com/nahasu/k8s/main/init_cfg.sh", args: [ N, k8s_V ]
      subconfig.vm.provision "shell", path: "https://raw.githubusercontent.com/nahasu/k8s/main/worker.sh"
    end
  end
...
#-----Client PC Subnet
    config.vm.define "k8s-pc" do |subconfig|
      ...
      subconfig.vm.provision "shell", path: "https://raw.githubusercontent.com/nahasu/k8s/main/client_pc.sh", args: N
    end
end
